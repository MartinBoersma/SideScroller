...
{
    public partial class lvl2_H : Form
    {
        ...
        private void lvl2_H_Load(object sender, EventArgs e)
        {
        ...
        private void MainTimerEvent(object sender, EventArgs e)
        {
            ...
            if (player.Bounds.IntersectsWith(finish.Bounds))
            {
                ...
                {
                    mission2Complete finishwsWindow = new mission2Complete(); //level 3 has to have the name as MC_I_lvl3, this means MissionComplete_Intel_Level3
                ...
                {
                    mission2Complete_HARD finishWindow = new mission2Complete_HARD(); //this is the version without the collected intel from level 2, so it has to have an extra enemy
            ...
            if (enemy1.Left < platformEnemy1.Left || enemy1.Left + enemy1.Width > platformEnemy1.Left + platformEnemy1.Width)  //platformEnemy == the platform the enemies move on
            {
        ...
        private void lvl2_H_Load_1(object sender, EventArgs e)
        {
