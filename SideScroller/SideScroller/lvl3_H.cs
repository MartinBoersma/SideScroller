...
{
    public partial class lvl3_H : Form
    {
        ...
        private void lvl3_H_Load(object sender, EventArgs e)
        {
        ...
        private void MainTimerEvent(object sender, EventArgs e)
        {
            ...
            if (player.Bounds.IntersectsWith(finish.Bounds))
            {
                ...
                {
                    gameComplete finishwsWindow = new gameComplete(); 
                ...
                {
                    gameComplete finishWindow = new gameComplete(); 
